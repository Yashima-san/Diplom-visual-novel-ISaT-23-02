...
################################################################################
## ТРАНСФОРМАЦИИ ДЛЯ ПЕРСОНАЖЕЙ (ИСПРАВЛЕНО)
################################################################################

# Основные трансформации для разных ситуаций
transform character_scale:
    zoom 0.28  # Оптимальный размер для спрайтов 3480x2160 на экране 1920x1080
    xalign 0.5
    yalign 1.0

# Для крупных планов
transform character_scale_close:
    zoom 0.29
    xalign 0.5
    yalign 1.0

# Для сцен с двумя персонажами
transform character_scale_left:
    zoom 0.28
    xalign 0.25
    yalign 1.0

# Плавное приближение в центре с мягким эффектом
transform character_scale_center_soft_approach:
    zoom 0.28
    xalign 0.5  # Исправлено: центр (было 0.75 - это правая позиция)
    yalign 1.0
    easein 1.2 zoom 0.31  # Мягкое приближение
    pause 0.1
    easeout 0.28

# Для сцен с тремя персонажами
transform character_scale_leftmost:
    zoom 0.28
    xalign 0.15
    yalign 1.0
...
transform character_scale_rightmost:
    zoom 0.28
    xalign 0.85
    yalign 1.0
...
transform character_scale_fadeout:
    zoom 0.28
    alpha 1.0
...
# Для эмоциональных моментов (легкое покачивание)
transform character_scale_bounce:
    zoom 0.29
    xalign 0.5
    yalign 1.0
...
label continue_morning:
    ...
    # Шаги продолжаются до школы
    scene bg school_entrance with fade
    # НЕ останавливаем шаги - они продолжаются
    ...
    # Останавливаем шаги только когда она подходит к школе
    ...
    scene black with fade
    # Останавливаем школьную музыку в конце главы
...
label chapter_two:
    ...
    # ИСПРАВЛЕНО: Добавлены трансформации для персонажей
    ...
    # ИСПРАВЛЕНО: Два персонажа с правильным позиционированием
    ...
    # ИСПРАВЛЕНО: Добавлена трансформация
    ...
    # ИСПРАВЛЕНО: Три персонажа с правильным позиционированием
